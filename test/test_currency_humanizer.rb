...
class TestCurrencyHumanizer < Test::Unit::TestCase
  ...
  def test_tens_part
    assert_equal "",        CurrencyHumanizer.tens_part("0")
    assert_equal "ten",     CurrencyHumanizer.tens_part("1"), "1 should return 'ten'"
    assert_equal "twenty",  CurrencyHumanizer.tens_part("2"), "2 should return 'twenty'"
    assert_equal "thirty",  CurrencyHumanizer.tens_part("3"), "3 should return 'thirty'"
    assert_equal "fourty",  CurrencyHumanizer.tens_part("4"), "4 should return 'fourty'"
    assert_equal "fifty",   CurrencyHumanizer.tens_part("5"), "5 should return 'fifty'"
    assert_equal "sixty",   CurrencyHumanizer.tens_part("6"), "6 should return 'sixty'"
    assert_equal "seventy", CurrencyHumanizer.tens_part("7"), "7 should return 'seventy'"
    assert_equal "eighty",  CurrencyHumanizer.tens_part("8"), "8 should return 'eighty'"
    assert_equal "ninety",  CurrencyHumanizer.tens_part("9"), "9 should return 'ninety'"
  end
  ...
  def test_tens_and_ones_part
    assert_equal "", CurrencyHumanizer.tens_and_ones_part("00"), "00 should return ''"
    assert_equal "one", CurrencyHumanizer.tens_and_ones_part("01"), "01 should return 'one'"
    assert_equal "two", CurrencyHumanizer.tens_and_ones_part("02"), "02 should return 'two'"
    assert_equal "three", CurrencyHumanizer.tens_and_ones_part("03"), "03 should return 'three'"
    assert_equal "four", CurrencyHumanizer.tens_and_ones_part("04"), "04 should return 'four'"
    assert_equal "five", CurrencyHumanizer.tens_and_ones_part("05"), "05 should return 'five'"
    assert_equal "six", CurrencyHumanizer.tens_and_ones_part("06"), "06 should return 'six'"
    assert_equal "seven", CurrencyHumanizer.tens_and_ones_part("07"), "07 should return 'seven'"
    assert_equal "eight", CurrencyHumanizer.tens_and_ones_part("08"), "08 should return 'eight'"
    assert_equal "nine", CurrencyHumanizer.tens_and_ones_part("09"), "09 should return 'nine'"
    assert_equal "ten", CurrencyHumanizer.tens_and_ones_part("10"), "10 should return 'ten'"
    assert_equal "eleven", CurrencyHumanizer.tens_and_ones_part("11"), "11 should return 'eleven'"
    assert_equal "twelve", CurrencyHumanizer.tens_and_ones_part("12"), "12 should return 'twelve'"
    assert_equal "thirteen", CurrencyHumanizer.tens_and_ones_part("13"), "13 should return 'thirteen'"
    assert_equal "fourteen", CurrencyHumanizer.tens_and_ones_part("14"), "14 should return 'fourteen'"
    assert_equal "fifteen", CurrencyHumanizer.tens_and_ones_part("15"), "15 should return 'fifteen'"
    assert_equal "sixteen", CurrencyHumanizer.tens_and_ones_part("16"), "16 should return 'sixteen'"
    assert_equal "seventeen", CurrencyHumanizer.tens_and_ones_part("17"), "17 should return 'seventeen'"
    assert_equal "eighteen", CurrencyHumanizer.tens_and_ones_part("18"), "18 should return 'eighteen'"
    assert_equal "nineteen", CurrencyHumanizer.tens_and_ones_part("19"), "19 should return 'nineteen'"
    assert_equal "twenty", CurrencyHumanizer.tens_and_ones_part("20"), "20 should return 'twenty'"
    assert_equal "thirty", CurrencyHumanizer.tens_and_ones_part("30"), "30 should return 'thirty'"
    assert_equal "fourty", CurrencyHumanizer.tens_and_ones_part("40"), "40 should return 'fourty'"
    assert_equal "fifty", CurrencyHumanizer.tens_and_ones_part("50"), "50 should return 'fifty'"
    assert_equal "sixty", CurrencyHumanizer.tens_and_ones_part("60"), "60 should return 'sixty'"
    assert_equal "seventy", CurrencyHumanizer.tens_and_ones_part("70"), "70 should return 'seventy'"
    assert_equal "eighty", CurrencyHumanizer.tens_and_ones_part("80"), "80 should return 'eighty'"
    assert_equal "ninety", CurrencyHumanizer.tens_and_ones_part("90"), "90 should return 'ninety'"
    assert_equal "ninety-one", CurrencyHumanizer.tens_and_ones_part("91"), "91 should return 'ninety-one'"
    assert_equal "ninety-two", CurrencyHumanizer.tens_and_ones_part("92"), "92 should return 'ninety-two'"
    assert_equal "ninety-three", CurrencyHumanizer.tens_and_ones_part("93"), "93 should return 'ninety-three'"
    assert_equal "ninety-four", CurrencyHumanizer.tens_and_ones_part("94"), "94 should return 'ninety-four'"
    assert_equal "ninety-five", CurrencyHumanizer.tens_and_ones_part("95"), "95 should return 'ninety-five'"
    assert_equal "ninety-six", CurrencyHumanizer.tens_and_ones_part("96"), "96 should return 'ninety-six'"
    assert_equal "ninety-seven", CurrencyHumanizer.tens_and_ones_part("97"), "97 should return 'ninety-seven'"
    assert_equal "ninety-eight", CurrencyHumanizer.tens_and_ones_part("98"), "98 should return 'ninety-eight'"
    assert_equal "ninety-nine", CurrencyHumanizer.tens_and_ones_part("99"), "99 should return 'ninety-nine'"
  end
